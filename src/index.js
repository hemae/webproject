...
let mainLogo = "https://km.insma.urfu.ru/documents/logotype/cm_544x250.png"
...
let routeData = [
    {
        path: "/main",
        component: <Main quantityData={quantityData} materialsData={materialsData} propertiesData={propertiesData}
                         mainLogo={mainLogo}/>
    },
    {path: "/messenger", component: <Messenger dialoguesData={dialoguesData} chatData={chatData}/>},
